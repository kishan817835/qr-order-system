    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex space-x-3">
          {tables.length > 0 && (
            <button onClick={printAllQRCodes} className="btn btn-secondary">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center space-x-2">
                <select
                  value={table.status}
                  onChange={(e) =>
                    changeTableStatus(table.id, e.target.value as any)
                  }
                  className={`status-select text-xs font-medium border-0 rounded-full px-2 py-1 text-white ${getStatusColor(table.status)}`}
                  style={{
                    backgroundColor: getStatusColor(table.status).includes(
                      "bg-green",
                    )
                      ? "#16a34a"
                      : getStatusColor(table.status).includes("bg-red")
                        ? "#dc2626"
                        : getStatusColor(table.status).includes("bg-orange")
                          ? "#ea580c"
                          : "#6b7280",
                  }}
                >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewTable({
                      ...newTable,
                      chairCount: parseInt(e.target.value) || 1,
                    })
                  }
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewTable({ ...newTable, status: e.target.value as any })
                  }
                >
                  <option value="available">Available</option>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditTable({ ...editTable, location: e.target.value })
                  }
                />
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <QRCodeGenerator
              ...
              onDownload={() => {
                console.log(
                  `Downloaded QR for Table ${selectedTable.tableNumber}`,
                );
              }}
            />
          </div>
