    ...
    <div className="text-center space-y-4">
      ...
      {tableNumber && (
        <div className="space-y-2">
          <p className="text-sm font-medium text-primary">Table {tableNumber} QR Code</p>
          <p className="text-xs text-secondary">Scan to order directly to this table</p>
        </div>
      )}
