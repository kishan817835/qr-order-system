...
export default function DeliveryDetailsPage() {
  ...
  const notifyCustomer = () => {
    ...
    alert(
      `Customer ${order?.customer.name} notified: "Your order is on the way! Delivery boy: ${order?.deliveryBoy.name} (${order?.deliveryBoy.phone})"`,
    );
  };
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-primary">
                  ...
                  {!orderId && (
                    <span className="ml-2 text-xs bg-orange text-white px-2 py-1 rounded">
                      DEMO
                    </span>
                  )}
                </h1>
          ...
          <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  {currentLocation && order.customer.coordinates && (
                    <div className="mt-2 text-xs text-secondary">
                      <p>
                        From: {currentLocation.lat.toFixed(4)},{" "}
                        {currentLocation.lng.toFixed(4)}
                      </p>
                      <p>
                        To: {order.customer.coordinates.lat.toFixed(4)},{" "}
                        {order.customer.coordinates.lng.toFixed(4)}
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-orange bg-opacity-10 border border-orange text-orange p-3 rounded-lg">
                    ...
                    <p className="text-sm mt-1">
                      Ready to start delivery journey
                    </p>
                  </div>
                  <button
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button onClick={callCustomer} className="btn btn-secondary">
                  <Phone className="w-4 h-4 mr-2" />
                  Call Customer
                </button>
                <button
                ...
                <button onClick={openGoogleMaps} className="btn btn-secondary">
                  <Navigation className="w-4 h-4 mr-2" />
                  Navigation
                </button>
