      ...
      <div className="space-y-6">
        ...
        <div className="card">
          ...
          <div className="space-y-3">
            {days.map(({ key, label }) => {
              const dayHours =
                settings.openingHours[
                  key as keyof typeof settings.openingHours
                ];
              return (
                <div key={key} className="flex items-center space-x-4">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        updateOpeningHours(key, "closed", !e.target.checked)
                      }
                      className="mr-2"
                    />
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="form-label">
                Takeaway Preparation Time (minutes)
              </label>
              <input
                type="text"
                className="form-input"
                ...
                onChange={(e) =>
                  setSettings({ ...settings, takeawayTime: e.target.value })
                }
              />
            </div>
          </div>
